...
export function Footer() {
  const footerLinks = {
    ...
    community: [
      { name: "Discord", href: "https://discord.gg/fKpUQxDdyG", icon: DiscordLogo },
      { name: "Twitter", href: "https://x.com/DAGChain_ai", icon: XLogo },
      { name: "Telegram", href: "https://t.me/DAGChain_network", icon: TelegramLogo },
      { name: "Medium", href: "https://medium.com/@DAGChain", icon: MediumLogo },
  ...
  const socialLinks = [
    { name: "Discord", icon: DiscordLogo, href: "https://discord.gg/fKpUQxDdyG", color: "hover:text-gray-700" },
    { name: "Twitter", icon: XLogo, href: "https://x.com/dagchain_ai", color: "hover:text-gray-700" },
    { name: "TikTok", icon: TikTokLogo, href: "https://www.tiktok.com/@dagchain", color: "hover:text-gray-800" },
    { name: "Telegram", icon: TelegramLogo, href: "https://t.me/dagchain_network", color: "hover:text-gray-700" },
    { name: "Medium", icon: MediumLogo, href: "https://medium.com/@dagchain", color: "hover:text-gray-700" },
    { name: "Instagram", icon: InstagramLogo, href: "https://www.instagram.com/dagchain.network/", color: "hover:text-gray-700" },
    { name: "Facebook", icon: FacebookLogo, href: "https://www.facebook.com/people/DagChain/61584495032870/", color: "hover:text-gray-700" },
    { name: "LinkedIn", icon: LinkedInLogo, href: "https://www.linkedin.com/company/dag-chain", color: "hover:text-gray-700" },
    { name: "YouTube", icon: YouTubeLogo, href: "https://www.youtube.com/@dagchain.network", color: "hover:text-gray-700" }
  ]
                  ...
                  {footerLinks.company.map((link, index) => {
                    ...
                    return (
                      <li key={index}>
                        <a
                          href={link.href}
                          target={link.name === "Media Kit" ? "_blank" : undefined}
                          rel={link.name === "Media Kit" ? "noopener noreferrer" : undefined}
                          className="flex items-center gap-2 text-white/80 hover:text-white transition-colors group font-inter"
                        >
                          <IconComponent className="w-3 h-3 group-hover:scale-110 transition-transform" />
                          <span className="text-xs">{link.name}</span>
          ...
          <div className="relative z-10 border-t border-white/20 pt-4">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-1">
                <span className="text-white/70 text-xs font-inter">Made with</span>
                <Heart className="w-3 h-3 text-white/70 animate-pulse" />
                <span className="text-white/70 text-xs font-inter">for the AI community</span>
              </div>
            </div>
          </div>
        </motion.div>
