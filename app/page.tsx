...
const Roadmap = dynamic(() => import('@/components/roadmap').then(mod => ({ ssr: true, default: mod.Roadmap })));
const Tokenomics = dynamic(() => import('@/components/tokenomics').then(mod => ({ ssr: true, default: mod.Tokenomics })));
...
const Ecosystem = dynamic(() => import("@/components/ecosystem").then(mod => ({ ssr: true, default: mod.Ecosystem })));
