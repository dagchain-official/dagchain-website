...
export default function WebpageEditor({ params }: Props) {
  ...
  const [imageUrl, setImageUrl] = useState("/frontend/images/article/bg_top_banner_product_knowledge.png");
  ...
  const addQuestion = () => {
    setForm((p) => ({
      ...p,
      questions: [...p.questions, { title: "", answer: "" }],
    }));
  };
  ...
  const updateQuestion = (
    ...
    // Update form data
    setForm((p) => {
      const updated = [...p.questions];
      updated[index] = { ...updated[index], [field]: value };
      return { ...p, questions: updated };
    });

    // Clear error ONLY for this question + field
    setErrors((e) => {
      if (!e.questions?.[index]) return e;
  ...
  useEffect(() => {
    ...
    async function loadExistingPage() {
      ...
      setForm({
        ...
        questions: data.questions.length ? data.questions : form.questions,
  ...
  const validateStep4 = () => {
    ...
    form.questions.forEach((q, index) => {
      ...
      if (Object.keys(qe).length > 0) {
        e.questions[index] = qe;
      }
    });

    setErrors(hasError ? e : {});
    return !hasError;
  };
  ...
  async function publishPage() {
    ...
    if (res.ok) router.replace("/admin/product-knowledge");
  }
        ...
        <div className="custom_container">
          ...
          <div className="step_content step1">
            <div className="fullrow_top">
              <h3> {(isNew ? 'Create A ' : 'Modify ') + 'Product Knowledge Page'} </h3>
            ...
            <div className="fullrow_btm">
              ...
              <div className="two_btn">
                <a href="/admin/product-knowledge" className="c_btn border_btn">Cancel</a>
          ...
          <div className="step_content step4 d-none">
            <div className="fullrow_top">
              ...
              <h3>Write Product Knowledge Q & A</h3>
              <span className="c_border"></span>
            </div>
            <div className="fullrow_mid">
              <div className="formarea">
                <div className="filedwrap mw_1040">
                  <div className="faq_section">
                    {form.questions.map((q, index) => (
                      <div className="common_wrap" key={index}>
                        <div className="common_section">
                          <div className="flex justify-between">
                            <div className="faq_heading">
                              <h3>Question {index + 1}</h3>
                              <p>Provide the Question & Answer</p>
                            </div>
                            {/* DELETE (allowed even for Q1) */}
                            {
                              index > 0 ?
                                <div className="full_btnrow">
                                  <button
                                    type="button"
                                    className="c_btn border_btn red"
                          ...
                          <div className="fullrow">
                            <div className="row_withbtn">
                              <div className="custom_label flex">
                                <div className="icon my-auto">
                                  <img src="/admin/images/create-webpage/icon_title.svg" alt="icon" />
                                </div>
                                <span className="my-auto">Question {index + 1}</span>
                                <div className="mytooltip my-auto">
                                  <img src="/admin/images/common-images/icon_toolitip.svg" alt="icon"
                                    className="icon_tooltip" />
                                  <div className="tooltip_content top">
                                    <div className="arrow"></div>
                                    <div className="customscroll">
                                      <div className="text">
                                        <p>Enter a clear and direct question related to
                                          DagChain.</p>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div className="new_inputlabel">
                              <textarea
                                className="textarea text_autoheight heightnrml"
                                value={q.title}
                                onChange={(e) =>
                            ...
                            <div className={`error_msg ${errors.questions?.[index]?.title ? "" : "d-none"}`}>
                              <img src="/admin/images/common-images/icon_error.svg" alt="icon error"
                                className="licon" />
                              <div className="textbox">
                                <strong className="ttext">Error</strong>
                                <p>Enter a clear and direct question related to DagChain.</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="fullrow">
                            <div className="row_withbtn">
                              <div className="custom_label answer flex">
                                <div className="icon">
                                  <img className="my-auto" src="/admin/images/create-webpage/icon_content.svg" />
                                </div>
                                <span className="my-auto">Answer {index + 1}</span>
                                <div className="mytooltip my-auto">
                                  <img src="/admin/images/common-images/icon_toolitip.svg" alt="icon"
                                    className="icon_tooltip" />
                                  <div className="tooltip_content top">
                                    ...
                                    <div className="customscroll">
                                      <div className="text">
                                        <p>Write a complete and accurate answer to the
                                          question.</p>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div className="new_inputlabel">
                              <textarea
                                className="textarea text_autoheight mh_250"
                                value={q.answer}
                                onChange={(e) =>
                            ...
                            <div className={`error_msg ${errors.questions?.[index]?.answer ? "" : "d-none"}`}>
                              <img src="/admin/images/common-images/icon_error.svg" alt="icon error"
                                className="licon" />
                              <div className="textbox">
                                <strong className="ttext">Error</strong>
                                <p>Answer is required | Answer is too short</p>
                              </div>
                            </div>
                          </div>
            ...
            <div className="fullrow_btm">
              <div className="progress_wrap">
                ...
                <div className="custom_progress">
                  <span className="show_progress w-full"></span>
                </div>
              </div>
              <div className="two_btn">
                <a href="/admin/product-knowledge" className="c_btn border_btn">Cancel</a>
